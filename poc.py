...
def send_queries_through_resolvers(domain, resolvers, server_port, num_queries, interval, verbose, qtype_name='A', edns_payload=0, dnssec_do=False, measure=False):
    ...
    for resolver in resolvers:
        for _ in range(num_queries):
            thread = threading.Thread(target=send_dns_query, args=(domain, resolver, server_port, interval, verbose, qtype_name, edns_payload, dnssec_do, measure, timeout))
...
if __name__ == "__main__":
    ...
    if not args.domain or not args.port:
        ...
        if args.file:
            ...
            send_queries_through_resolvers(args.domain, resolvers, args.port, args.num_queries, args.interval, args.verbose, args.qtype, args.edns_payload, args.dnssec_do, args.measure, args.timeout, args.bufsize)
